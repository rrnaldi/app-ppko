...
<head>
    ...
    <title>Dashboard - Departemen GA</title>
                        ...
                        <div class="card-body">
                            ...
                            <div style="overflow-x: auto;">
                                <table id="datatablesSimple" class="table table-bordered table-striped table-hover">
                                    ...
                                    $tampil = mysqli_query($koneksi, "SELECT p.*, u.* FROM pengajuan p  JOIN user u on u.nik= p.id_author  WHERE p.status='Disetujui Manager' ORDER BY id_pengajuan DESC");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Tombol Persetujuan -->
                                                <a class="btn btn-primary mb-3" href="aksi_crud.php?action=diterima_umum&id=<?= $data['id_pengajuan'] ?>">Terima</a>
                                                <a class="btn btn-primary mb-3" href="aksi_crud.php?action=tolak_approve&id=<?= $data['id_pengajuan'] ?>">Tolak</a>
                                            </td>
                                        </tr>
                                    <?php endwhile ?>
                                </table>
