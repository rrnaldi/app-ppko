                                ...
                                <table id="datatablesSimple" class="table table-bordered table-striped table-hover">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Tombol Persetujuan -->
                                                <a class="btn btn-primary mb-3" href="aksi_crudAP.php?action=dievaluasi_asmen&id=<?= $data['id_pengajuan'] ?>">Setuju</a>
                                                <a class="btn btn-primary mb-3" href="aksi_crudAP.php?action=tolak_approveA&id=<?= $data['id_pengajuan'] ?>">Tidak Setuju</a>
                                            </td>
                                        </tr>
                                        <?php
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <ul class="list-group list-group-flush">
                                                                        ...
                                                                        <li class="list-group-item"><strong>NIK:</strong> <?= $data['nik'] ?></li>
