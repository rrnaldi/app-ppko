                        ...
                        <div class="card-body">
                            ...
                            <div style="overflow-x: auto;">
                                <table id="datatablesSimple" class="table table-bordered table-striped table-hover">
                                    ...
                                    $tampil = mysqli_query($koneksi, "SELECT p.*, u.* FROM pengajuan p  JOIN user u on u.nik= p.id_author WHERE p.status='Telah Diajukan' ORDER BY id_pengajuan DESC");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Tombol Persetujuan -->
                                                <a class="btn btn-primary mb-3" href="aksi_crudAP.php?action=update_approveM&id=<?= $data['id_pengajuan'] ?>">Setuju</a>
                                                <a class="btn btn-primary mb-3" href="aksi_crudAP.php?action=tolak_approveM&id=<?= $data['id_pengajuan'] ?>">Tidak Setuju</a>
                                            </td>
                                        </tr>
                                    <?php endwhile ?>
                                </table>
