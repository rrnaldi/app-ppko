                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary fw-bold text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="PManager.php">View Details</a>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-danger fw-bold text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="PUmum.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    <p class="card-text">
                                        <?php
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-secondary fw-bold text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="PSpv.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    <p class="card-text">
                                        <?php
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-success fw-bold text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="PAsmen.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    <p class="card-text">
                                        <?php
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary fw-bold text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="Selesai.php">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    <p class="card-text">
                                        <?php
