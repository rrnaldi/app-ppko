                                ...
                                <table id="datatablesSimple" class="table table-bordered table-striped table-hover">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Tombol Persetujuan -->
                                                <a class="btn btn-primary mb-3" href="aksi_crudAP.php?action=diterima_umum&id=<?= $data['id_pengajuan'] ?>">Terima</a>
                                                <a class="btn btn-primary mb-3" href="aksi_crudAP.php?action=tolak_approveB&id=<?= $data['id_pengajuan'] ?>">Tolak</a>
                                            </td>
                                        </tr>
                                    <?php endwhile ?>
                                </table>
